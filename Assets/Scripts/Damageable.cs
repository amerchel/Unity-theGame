...
public class Damageable : MonoBehaviour
{
    ...
    // The velocity shouldn't be changed while this is true but needs to be respected by other physics component like
    ...
    public bool Hit(int damage, Vector2 knockback)
    {
        if (IsAlive && !isInvincible)
        {
            ...
            // Notify other components that there was a hit to handle knockback
